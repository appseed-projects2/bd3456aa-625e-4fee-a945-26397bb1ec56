...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-21 09:35`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/bd3456aa-625e-4fee-a945-26397bb1ec56.git
$ cd bd3456aa-625e-4fee-a945-26397bb1ec56
```
